...
namespace AUTD3Sharp.Modulation.AudioFile {
    partial class Wav : AUTD3Sharp.Driver.Datagram.Modulation.IModulation, IDatagramST<ModulationPtr>, IDatagram
    {
        ...
        [ExcludeFromCodeCoverage] public DatagramWithSegmentTransition<Wav, ModulationPtr> WithSegment(Segment segment, TransitionModeWrap? transitionMode) => new DatagramWithSegmentTransition<Wav, ModulationPtr>(this, segment, transitionMode);
        ...
        [ExcludeFromCodeCoverage] public Wav WithLoopBehavior(AUTD3Sharp.NativeMethods.LoopBehavior loopBehavior)
        {
        ...
        [ExcludeFromCodeCoverage] public AUTD3Sharp.Driver.Datagram.Modulation.Cache<Wav> WithCache() => new AUTD3Sharp.Driver.Datagram.Modulation.Cache<Wav>(this);
        ...
        [ExcludeFromCodeCoverage] public AUTD3Sharp.Driver.Datagram.Modulation.RadiationPressure<Wav> WithRadiationPressure() => new AUTD3Sharp.Driver.Datagram.Modulation.RadiationPressure<Wav>(this);
        [ExcludeFromCodeCoverage] public AUTD3Sharp.Driver.Datagram.Modulation.Transform<Wav> WithTransform(Func<int, EmitIntensity, EmitIntensity> f) => new AUTD3Sharp.Driver.Datagram.Modulation.Transform<Wav>(this, f);
    }
}