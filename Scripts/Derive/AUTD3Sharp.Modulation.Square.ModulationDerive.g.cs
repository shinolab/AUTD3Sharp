...
namespace AUTD3Sharp.Modulation {
    partial class Square : AUTD3Sharp.Driver.Datagram.Modulation.IModulation, IDatagramST<ModulationPtr>, IDatagram
    {
        ...
        [ExcludeFromCodeCoverage] public DatagramWithSegmentTransition<Square, ModulationPtr> WithSegment(Segment segment, TransitionModeWrap? transitionMode) => new DatagramWithSegmentTransition<Square, ModulationPtr>(this, segment, transitionMode);
        ...
        [ExcludeFromCodeCoverage] public Square WithLoopBehavior(AUTD3Sharp.NativeMethods.LoopBehavior loopBehavior)
        {
        ...
        [ExcludeFromCodeCoverage] public AUTD3Sharp.Driver.Datagram.Modulation.Cache<Square> WithCache() => new AUTD3Sharp.Driver.Datagram.Modulation.Cache<Square>(this);
        ...
        [ExcludeFromCodeCoverage] public AUTD3Sharp.Driver.Datagram.Modulation.RadiationPressure<Square> WithRadiationPressure() => new AUTD3Sharp.Driver.Datagram.Modulation.RadiationPressure<Square>(this);
        [ExcludeFromCodeCoverage] public AUTD3Sharp.Driver.Datagram.Modulation.Transform<Square> WithTransform(Func<int, EmitIntensity, EmitIntensity> f) => new AUTD3Sharp.Driver.Datagram.Modulation.Transform<Square>(this, f);
    }
}