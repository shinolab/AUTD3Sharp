...
namespace AUTD3Sharp.Gain {
    public partial class Plane : AUTD3Sharp.Driver.Datagram.Gain.IGain, IDatagramS<GainPtr>, IDatagram
    {
        ...
        [ExcludeFromCodeCoverage] public DatagramWithSegment<Plane, GainPtr> WithSegment(Segment segment, bool updateSegment)
        {
            return new DatagramWithSegment<Plane, GainPtr>(this, segment, updateSegment);
        }
        ...
        [ExcludeFromCodeCoverage] public AUTD3Sharp.Driver.Datagram.Gain.Transform<Plane> WithTransform(Func<AUTD3Sharp.Device, AUTD3Sharp.Transducer, AUTD3Sharp.Drive, AUTD3Sharp.Drive> f)
        {
