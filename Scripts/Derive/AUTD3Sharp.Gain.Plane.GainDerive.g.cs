...
namespace AUTD3Sharp.Gain {
    public partial class Plane : AUTD3Sharp.Driver.Datagram.Gain.IGain, IDatagramS<GainPtr>, IDatagram
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [ExcludeFromCodeCoverage] 
        public DatagramWithSegment<Plane, GainPtr> WithSegment(Segment segment, TransitionModeWrap? transitionMode) => new DatagramWithSegment<Plane, GainPtr>(this, segment, transitionMode);
