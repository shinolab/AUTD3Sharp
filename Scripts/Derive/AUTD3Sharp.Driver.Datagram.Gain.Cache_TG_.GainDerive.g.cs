...
namespace AUTD3Sharp.Driver.Datagram.Gain {
    public partial class Cache<TG> : AUTD3Sharp.Driver.Datagram.Gain.IGain, IDatagramS<GainPtr>, IDatagram
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [ExcludeFromCodeCoverage] 
        public DatagramWithSegment<Cache<TG>, GainPtr> WithSegment(Segment segment, TransitionModeWrap? transitionMode) => new DatagramWithSegment<Cache<TG>, GainPtr>(this, segment, transitionMode);
