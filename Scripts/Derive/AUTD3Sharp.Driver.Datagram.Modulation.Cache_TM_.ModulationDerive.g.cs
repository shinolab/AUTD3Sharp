...
namespace AUTD3Sharp.Driver.Datagram.Modulation {
    partial class Cache<TM> : AUTD3Sharp.Driver.Datagram.Modulation.IModulation, IDatagramS<ModulationPtr>, IDatagram
    {
        ...
        [ExcludeFromCodeCoverage] public DatagramWithSegment<Cache<TM>, ModulationPtr> WithSegment(Segment segment, bool updateSegment)
        {
            return new DatagramWithSegment<Cache<TM>, ModulationPtr>(this, segment, updateSegment);
        }
        ...
        /// <returns></returns>
        public Cache<TM> WithLoopBehavior(LoopBehavior loopBehavior)
        {
