...
namespace AUTD3Sharp.Driver.Datagram.Modulation {
    partial class Cache<TM> : AUTD3Sharp.Driver.Datagram.Modulation.IModulation, IDatagramST<ModulationPtr>, IDatagram
    {
        ...
        [ExcludeFromCodeCoverage] public DatagramWithSegmentTransition<Cache<TM>, ModulationPtr> WithSegment(Segment segment, TransitionModeWrap? transitionMode) => new DatagramWithSegmentTransition<Cache<TM>, ModulationPtr>(this, segment, transitionMode);
        ...
        [ExcludeFromCodeCoverage] public Cache<TM> WithLoopBehavior(AUTD3Sharp.NativeMethods.LoopBehavior loopBehavior)
        {
