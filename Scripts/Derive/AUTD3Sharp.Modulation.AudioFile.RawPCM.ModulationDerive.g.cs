...
namespace AUTD3Sharp.Modulation.AudioFile {
    partial class RawPCM : AUTD3Sharp.Driver.Datagram.Modulation.IModulation, IDatagramST<ModulationPtr>, IDatagram
    {
        ...
        [ExcludeFromCodeCoverage] public DatagramWithSegmentTransition<RawPCM, ModulationPtr> WithSegment(Segment segment, TransitionModeWrap? transitionMode) => new DatagramWithSegmentTransition<RawPCM, ModulationPtr>(this, segment, transitionMode);
        ...
        [ExcludeFromCodeCoverage] public RawPCM WithLoopBehavior(AUTD3Sharp.NativeMethods.LoopBehavior loopBehavior)
        {
        ...
        [ExcludeFromCodeCoverage] public AUTD3Sharp.Driver.Datagram.Modulation.Cache<RawPCM> WithCache() => new AUTD3Sharp.Driver.Datagram.Modulation.Cache<RawPCM>(this);
              
        public RawPCM WithSamplingConfig(SamplingConfigWrap config)
        {
            _config = config;
            return this;
        }
        [ExcludeFromCodeCoverage] public AUTD3Sharp.Driver.Datagram.Modulation.RadiationPressure<RawPCM> WithRadiationPressure() => new AUTD3Sharp.Driver.Datagram.Modulation.RadiationPressure<RawPCM>(this);
        [ExcludeFromCodeCoverage] public AUTD3Sharp.Driver.Datagram.Modulation.Transform<RawPCM> WithTransform(Func<int, EmitIntensity, EmitIntensity> f) => new AUTD3Sharp.Driver.Datagram.Modulation.Transform<RawPCM>(this, f);
    }
}