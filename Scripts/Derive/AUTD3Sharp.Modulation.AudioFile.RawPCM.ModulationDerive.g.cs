...
namespace AUTD3Sharp.Modulation.AudioFile {
    partial class RawPCM : AUTD3Sharp.Driver.Datagram.Modulation.IModulation, IDatagramS<ModulationPtr>, IDatagram
    {
        ...
        [ExcludeFromCodeCoverage] public DatagramWithSegment<RawPCM, ModulationPtr> WithSegment(Segment segment, bool updateSegment)
        {
            return new DatagramWithSegment<RawPCM, ModulationPtr>(this, segment, updateSegment);
        }
        ...
        /// <returns></returns>
        public RawPCM WithLoopBehavior(LoopBehavior loopBehavior)
        {
        ...
        [ExcludeFromCodeCoverage] public AUTD3Sharp.Driver.Datagram.Modulation.Cache<RawPCM> WithCache()
        {
            return new AUTD3Sharp.Driver.Datagram.Modulation.Cache<RawPCM>(this);
        }

              
        public RawPCM WithSamplingConfig(SamplingConfiguration config)
        {
            _config = config;
            return this;
        }
        ...
        [ExcludeFromCodeCoverage] public AUTD3Sharp.Driver.Datagram.Modulation.RadiationPressure<RawPCM> WithRadiationPressure()
        {
            return new AUTD3Sharp.Driver.Datagram.Modulation.RadiationPressure<RawPCM>(this);
        }

              
        [ExcludeFromCodeCoverage] public AUTD3Sharp.Driver.Datagram.Modulation.Transform<RawPCM> WithTransform(Func<int, EmitIntensity, EmitIntensity> f)
        {
            return new AUTD3Sharp.Driver.Datagram.Modulation.Transform<RawPCM>(this, f);
        }
