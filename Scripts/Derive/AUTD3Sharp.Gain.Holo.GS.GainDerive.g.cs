...
namespace AUTD3Sharp.Gain.Holo {
    public partial class GS : AUTD3Sharp.Driver.Datagram.Gain.IGain, IDatagramS<GainPtr>, IDatagram
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [ExcludeFromCodeCoverage] 
        public DatagramWithSegment<GS, GainPtr> WithSegment(Segment segment, TransitionModeWrap? transitionMode) => new DatagramWithSegment<GS, GainPtr>(this, segment, transitionMode);
