...
namespace AUTD3Sharp.Driver.Datagram.Modulation {
    partial class RadiationPressure<TM> : AUTD3Sharp.Driver.Datagram.Modulation.IModulation, IDatagramST<ModulationPtr>, IDatagram
    {
        ...
        [ExcludeFromCodeCoverage] public DatagramWithSegmentTransition<RadiationPressure<TM>, ModulationPtr> WithSegment(Segment segment, TransitionModeWrap? transitionMode) => new DatagramWithSegmentTransition<RadiationPressure<TM>, ModulationPtr>(this, segment, transitionMode);
        ...
        [ExcludeFromCodeCoverage] public RadiationPressure<TM> WithLoopBehavior(AUTD3Sharp.NativeMethods.LoopBehavior loopBehavior)
        {
        ...
        [ExcludeFromCodeCoverage] public AUTD3Sharp.Driver.Datagram.Modulation.Cache<RadiationPressure<TM>> WithCache() => new AUTD3Sharp.Driver.Datagram.Modulation.Cache<RadiationPressure<TM>>(this);
