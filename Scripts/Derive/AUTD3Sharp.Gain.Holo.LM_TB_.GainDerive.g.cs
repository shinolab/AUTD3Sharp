...
namespace AUTD3Sharp.Gain.Holo {
    public partial class LM<TB> : AUTD3Sharp.Driver.Datagram.Gain.IGain, IDatagramS<GainPtr>, IDatagram
    {
        ...
        [ExcludeFromCodeCoverage] public DatagramWithSegment<LM<TB>, GainPtr> WithSegment(Segment segment, bool updateSegment)
        {
            return new DatagramWithSegment<LM<TB>, GainPtr>(this, segment, updateSegment);
        }
        ...
        [ExcludeFromCodeCoverage] public AUTD3Sharp.Driver.Datagram.Gain.Transform<LM<TB>> WithTransform(Func<AUTD3Sharp.Device, AUTD3Sharp.Transducer, AUTD3Sharp.Drive, AUTD3Sharp.Drive> f)
        {
