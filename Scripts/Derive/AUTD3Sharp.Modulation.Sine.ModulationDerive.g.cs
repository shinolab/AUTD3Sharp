...
namespace AUTD3Sharp.Modulation {
    partial class Sine : AUTD3Sharp.Driver.Datagram.Modulation.IModulation, IDatagramS<ModulationPtr>, IDatagram
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [ExcludeFromCodeCoverage]
        public DatagramWithSegment<Sine, ModulationPtr> WithSegment(Segment segment, TransitionModeWrap? transitionMode) => new DatagramWithSegment<Sine, ModulationPtr>(this, segment, transitionMode);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [ExcludeFromCodeCoverage]
        public Sine WithLoopBehavior(AUTD3Sharp.LoopBehavior loopBehavior)
        {
