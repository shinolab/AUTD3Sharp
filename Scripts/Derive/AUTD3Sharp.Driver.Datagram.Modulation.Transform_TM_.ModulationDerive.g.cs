...
namespace AUTD3Sharp.Driver.Datagram.Modulation {
    partial class Transform<TM> : AUTD3Sharp.Driver.Datagram.Modulation.IModulation, IDatagramS<ModulationPtr>, IDatagram
    {
        ...
        [ExcludeFromCodeCoverage] public DatagramWithSegment<Transform<TM>, ModulationPtr> WithSegment(Segment segment, bool updateSegment)
        {
            return new DatagramWithSegment<Transform<TM>, ModulationPtr>(this, segment, updateSegment);
        }
        ...
        /// <returns></returns>
        public Transform<TM> WithLoopBehavior(LoopBehavior loopBehavior)
        {
        ...
        [ExcludeFromCodeCoverage] public AUTD3Sharp.Driver.Datagram.Modulation.Cache<Transform<TM>> WithCache()
        {
            return new AUTD3Sharp.Driver.Datagram.Modulation.Cache<Transform<TM>>(this);
        }


              
        [ExcludeFromCodeCoverage] public AUTD3Sharp.Driver.Datagram.Modulation.RadiationPressure<Transform<TM>> WithRadiationPressure()
        {
            return new AUTD3Sharp.Driver.Datagram.Modulation.RadiationPressure<Transform<TM>>(this);
        }
