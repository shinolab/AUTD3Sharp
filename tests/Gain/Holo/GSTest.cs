...
#pragma warning disable CS8602, CS8605
        ...
        var backend = new NalgebraBackend();
        var g = new GS(backend, [(autd.Geometry.Center, 5e3f * Pa), (autd.Geometry.Center, 5e3f * Pa)]);
        Assert.True(AUTD3Sharp.NativeMethods.NativeMethodsGainHolo.AUTDGainGSIsDefault((AUTD3Sharp.NativeMethods.GainPtr)typeof(GS).GetMethod("GainPtr", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance).Invoke(g,
            [autd.Geometry])));
