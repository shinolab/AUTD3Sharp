...
#pragma warning disable CS8602, CS8605
        ...
        var backend = new NalgebraBackend();
        var g = new Naive<NalgebraBackend>(backend, [(autd.Geometry.Center, 5e3f * Pa), (autd.Geometry.Center, 5e3f * Pa)]);
        Assert.True(AUTD3Sharp.NativeMethods.NativeMethodsGainHolo.AUTDGainNaiveIsDefault((AUTD3Sharp.NativeMethods.GainPtr)typeof(Naive<NalgebraBackend>).GetMethod("GainPtr", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance).Invoke(g,
            [autd.Geometry])));
