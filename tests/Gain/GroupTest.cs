...
//            _ => "null"
//        }).Set("uniform", new Uniform(intensity: new EmitIntensity(0x80), phase: new Phase(0x90))).Set("null", new Null()));
...
//        {
//            autd.Send(new Group(_ => _ => "null").Set("uniform", new Uniform(intensity: new EmitIntensity(0x80), phase: new Phase(0x90))).Set("null", new Null()));
//        });
...
//                check[dev.Idx()] = true;
//                return "uniform";
//            }).Set("uniform", new Uniform(intensity: new EmitIntensity(0x80), phase: new Phase(0x90))));
