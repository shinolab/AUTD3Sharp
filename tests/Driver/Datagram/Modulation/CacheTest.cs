...
public class CacheTest
{
    ...
    {
        var autd1 = await new ControllerBuilder().AddDevice(new AUTD3(Vector3.Zero)).OpenAsync(Audit.Builder());
        var autd2 = await new ControllerBuilder().AddDevice(new AUTD3(Vector3.Zero)).OpenAsync(Audit.Builder());
    ...
    {
        var autd = new ControllerBuilder().AddDevice(new AUTD3(Vector3.Zero)).Open(Audit.Builder());
