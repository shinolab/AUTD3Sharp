...
namespace AUTD3Sharp.NativeMethods
{
    public static unsafe partial class NativeMethodsLinkVisualizer
    {
        ...
        public static extern uint AUTDLinkVisualizerPhasesOf(LinkPtr visualizer, Backend backend, Directivity directivity, Segment segment, ushort idx, byte* buf);
        ...
        public static extern uint AUTDLinkVisualizerIntensities(LinkPtr visualizer, Backend backend, Directivity directivity, Segment segment, ushort idx, byte* buf);
