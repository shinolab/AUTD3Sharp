...
namespace AUTD3Sharp.Modulation
{
    ...
    {
        internal ModulationPtr SinePtr(SamplingConfigWrap config, byte intensity, byte offset,
        ...
        internal ModulationPtr SquarePtr(SamplingConfigWrap config, byte low, byte high,
    ...
    internal sealed class SamplingModeExact : ISamplingMode
    {
        ...
        ModulationPtr ISamplingMode.SinePtr(SamplingConfigWrap config, byte intensity, byte offset,
            Angle phase, NativeMethods.LoopBehavior loopBehavior) => NativeMethodsBase.AUTDModulationSineExact(Freq.Hz, config, intensity, offset, phase.Radian, loopBehavior);
        ...
        ModulationPtr ISamplingMode.SquarePtr(SamplingConfigWrap config, byte low, byte high,
            float duty, NativeMethods.LoopBehavior loopBehavior) => NativeMethodsBase.AUTDModulationSquareExact(Freq.Hz, config, low, high, duty, loopBehavior);
    }
    ...
    internal sealed class SamplingModeExactFloat : ISamplingMode
    {
        ...
        ModulationPtr ISamplingMode.SinePtr(SamplingConfigWrap config, byte intensity, byte offset,
            Angle phase, NativeMethods.LoopBehavior loopBehavior) => NativeMethodsBase.AUTDModulationSineExactFloat(Freq.Hz, config, intensity, offset, phase.Radian, loopBehavior);
        ...
        ModulationPtr ISamplingMode.SquarePtr(SamplingConfigWrap config, byte low, byte high,
            float duty, NativeMethods.LoopBehavior loopBehavior) => NativeMethodsBase.AUTDModulationSquareExactFloat(Freq.Hz, config, low, high, duty, loopBehavior);
    }
    ...
    internal sealed class SamplingModeNearest : ISamplingMode
    {
        ...
        ModulationPtr ISamplingMode.SinePtr(SamplingConfigWrap config, byte intensity, byte offset,
            Angle phase, NativeMethods.LoopBehavior loopBehavior) => NativeMethodsBase.AUTDModulationSineNearest(Freq.Hz, config, intensity, offset, phase.Radian, loopBehavior);
        ...
        ModulationPtr ISamplingMode.SquarePtr(SamplingConfigWrap config, byte low, byte high,
            float duty, NativeMethods.LoopBehavior loopBehavior) => NativeMethodsBase.AUTDModulationSquareNearest(Freq.Hz, config, low, high, duty, loopBehavior);
    }
