...
namespace AUTD3Sharp.Driver.Datagram
{
    ...
    where T : IDatagram
    {
        ...
        DatagramPtr IDatagram.Ptr(Geometry geometry) => NativeMethodsBase.AUTDDatagramWithTimeout(_datagram.Ptr(geometry), _timeout.HasValue ? (long)(_timeout.Value.TotalMilliseconds * 1000 * 1000) : -1);
    }
}
